...
// A second one //
        ...
        {"// This is a comment ", Token_Comment}, {"int", Token_Int_Type}, {"main", Token_Id}, {"(", Token_Paren_Begin},
        {")", Token_Paren_End}, {"{", Token_Scope_Begin}, {"// A second one //", Token_Comment});
...
TEST(Lexer, Integer)
{
    ...
    Expect_Tokens("-+0xAbCdEf0123456789", {"-", Token_Sub}, {"+", Token_Add}, {"0xAbCdEf0123456789", Token_Int_Hex});
    Expect_Tokens("+-0XaBcdEf0123456789", {"+", Token_Add}, {"-", Token_Sub}, {"0XaBcdEf0123456789", Token_Int_Hex});
...
TEST(Lexer, Float)
{
    ...
    Expect_Tokens("+-+1234567890.", {"+", Token_Add}, {"-", Token_Sub}, {"+", Token_Add}, {"1234567890.", Token_Float});
    ...
    Expect_Tokens("1234567890.0123456789e+-", {"1234567890.0123456789e", Token_Float});
    Expect_Tokens("1234567890.0123456789e-+", {"1234567890.0123456789e", Token_Float});
    Expect_Tokens("1234567890.0123456789e--", {"1234567890.0123456789e", Token_Float}, {"--", Token_Decrement});
    Expect_Tokens("1234567890.0123456789e++", {"1234567890.0123456789e", Token_Float}, {"++", Token_Increment});
}
...
int unpack_file(const char* input_file) {
  ...
  if (!in) {
    ...
    return -1;
        ...
        {"/* warning: reset the read pointer to the beginning of the file */", Token_Comment}, {"int", Token_Int_Type},
        {"detect_magic", Token_Id}, {"(", Token_Paren_Begin}, {"FILE", Token_Id}, {"*", Token_Star}, {"f", Token_Id},
        {")", Token_Paren_End}, {"{", Token_Scope_Begin}, {"unsigned", Token_Unsigned}, {"char", Token_Char_Type},
        {"buffer", Token_Id}, {"[", Token_Crochet_Begin}, {"8", Token_Int}, {"]", Token_Crochet_End},
        {";", Token_Semicolon}, {"size_t", Token_Id}, {"bytes_read", Token_Id}, {";", Token_Semicolon},
        {"int", Token_Int_Type}, {"c", Token_Id}, {";", Token_Semicolon}, {"fseek", Token_Id}, {"(", Token_Paren_Begin},
        ...
        {"fread", Token_Id}, {"(", Token_Paren_Begin}, {"buffer", Token_Id}, {",", Token_Comma}, {"1", Token_Int},
        {",", Token_Comma}, {"8", Token_Int}, {",", Token_Comma}, {"f", Token_Id}, {")", Token_Paren_End},
        {";", Token_Semicolon}, {"fseek", Token_Id}, {"(", Token_Paren_Begin}, {"f", Token_Id}, {",", Token_Comma},
        {"SEEK_SET", Token_Id}, {",", Token_Comma}, {"0", Token_Int}, {")", Token_Paren_End}, {";", Token_Semicolon},
        {"if", Token_If}, {"(", Token_Paren_Begin}, {"bytes_read", Token_Id}, {"<", Token_Less}, {"8", Token_Int},
        {")", Token_Paren_End}, {"return", Token_Return}, {"0", Token_Int}, {";", Token_Semicolon}, {"for", Token_For},
        {"(", Token_Paren_Begin}, {"c", Token_Id}, {"=", Token_Assign}, {"0", Token_Int}, {";", Token_Semicolon},
        {"c", Token_Id}, {"<", Token_Less}, {"8", Token_Int}, {";", Token_Semicolon}, {"c", Token_Id},
        {"++", Token_Increment}, {")", Token_Paren_End}, {"if", Token_If}, {"(", Token_Paren_Begin},
        {"buffer", Token_Id}, {"[", Token_Crochet_Begin}, {"c", Token_Id}, {"]", Token_Crochet_End},
        {"!=", Token_Not_Eq}, {"sixpack_magic", Token_Id}, {"[", Token_Crochet_Begin}, {"c", Token_Id},
        {"]", Token_Crochet_End}, {")", Token_Paren_End}, {"return", Token_Return}, {"0", Token_Int},
        {";", Token_Semicolon}, {"return", Token_Return}, {"-", Token_Sub}, {"1", Token_Int}, {";", Token_Semicolon},
        {"}", Token_Scope_End}, {"static", Token_Static}, {"unsigned", Token_Unsigned}, {"long", Token_Long},
        {"readU16", Token_Id}, {"(", Token_Paren_Begin}, {"const", Token_Const}, {"unsigned", Token_Unsigned},
        ...
        {"0", Token_Int}, {"]", Token_Crochet_End}, {"+", Token_Add}, {"(", Token_Paren_Begin}, {"ptr", Token_Id},
        {"[", Token_Crochet_Begin}, {"1", Token_Int}, {"]", Token_Crochet_End}, {"<<", Token_Shift_L}, {"8", Token_Int},
        {")", Token_Paren_End}, {";", Token_Semicolon}, {"}", Token_Scope_End}, {"static", Token_Static},
        {"unsigned", Token_Unsigned}, {"long", Token_Long}, {"readU32", Token_Id}, {"(", Token_Paren_Begin},
        {"const", Token_Const}, {"unsigned", Token_Unsigned}, {"char", Token_Char_Type}, {"*", Token_Star},
        {"ptr", Token_Id}, {")", Token_Paren_End}, {"{", Token_Scope_Begin}, {"return", Token_Return},
        {"ptr", Token_Id}, {"[", Token_Crochet_Begin}, {"0", Token_Int}, {"]", Token_Crochet_End}, {"+", Token_Add},
        {"(", Token_Paren_Begin}, {"ptr", Token_Id}, {"[", Token_Crochet_Begin}, {"1", Token_Int},
        {"]", Token_Crochet_End}, {"<<", Token_Shift_L}, {"8", Token_Int}, {")", Token_Paren_End}, {"+", Token_Add},
        {"(", Token_Paren_Begin}, {"ptr", Token_Id}, {"[", Token_Crochet_Begin}, {"2", Token_Int},
        {"]", Token_Crochet_End}, {"<<", Token_Shift_L}, {"16", Token_Int}, {")", Token_Paren_End}, {"+", Token_Add},
        {"(", Token_Paren_Begin}, {"ptr", Token_Id}, {"[", Token_Crochet_Begin}, {"3", Token_Int},
        {"]", Token_Crochet_End}, {"<<", Token_Shift_L}, {"24", Token_Int}, {")", Token_Paren_End},
        {";", Token_Semicolon}, {"}", Token_Scope_End}, {"void", Token_Void_Type}, {"read_chunk_header", Token_Id},
        {"(", Token_Paren_Begin}, {"FILE", Token_Id}, {"*", Token_Star}, {"f", Token_Id}, {",", Token_Comma},
        {"int", Token_Int_Type}, {"*", Token_Star}, {"id", Token_Id}, {",", Token_Comma}, {"int", Token_Int_Type},
        {"*", Token_Star}, {"options", Token_Id}, {",", Token_Comma}, {"unsigned", Token_Unsigned},
        {"long", Token_Long}, {"*", Token_Star}, {"size", Token_Id}, {",", Token_Comma}, {"unsigned", Token_Unsigned},
        {"long", Token_Long}, {"*", Token_Star}, {"checksum", Token_Id}, {",", Token_Comma},
        {"unsigned", Token_Unsigned}, {"long", Token_Long}, {"*", Token_Star}, {"extra", Token_Id},
        {")", Token_Paren_End}, {"{", Token_Scope_Begin}, {"unsigned", Token_Unsigned}, {"char", Token_Char_Type},
        {"buffer", Token_Id}, {"[", Token_Crochet_Begin}, {"16", Token_Int}, {"]", Token_Crochet_End},
        {";", Token_Semicolon}, {"fread", Token_Id}, {"(", Token_Paren_Begin}, {"buffer", Token_Id}, {",", Token_Comma},
        {"1", Token_Int}, {",", Token_Comma}, {"16", Token_Int}, {",", Token_Comma}, {"f", Token_Id},
        {")", Token_Paren_End}, {";", Token_Semicolon}, {"*", Token_Star}, {"id", Token_Id}, {"=", Token_Assign},
        {"readU16", Token_Id}, {"(", Token_Paren_Begin}, {"buffer", Token_Id}, {")", Token_Paren_End},
        {"&", Token_Ampersand}, {"0xffff", Token_Int_Hex}, {";", Token_Semicolon}, {"*", Token_Star},
        {"options", Token_Id}, {"=", Token_Assign}, {"readU16", Token_Id}, {"(", Token_Paren_Begin},
        {"buffer", Token_Id}, {"+", Token_Add}, {"2", Token_Int}, {")", Token_Paren_End}, {"&", Token_Ampersand},
        {"0xffff", Token_Int_Hex}, {";", Token_Semicolon}, {"*", Token_Star}, {"size", Token_Id}, {"=", Token_Assign},
        {"readU32", Token_Id}, {"(", Token_Paren_Begin}, {"buffer", Token_Id}, {"+", Token_Add}, {"4", Token_Int},
        {")", Token_Paren_End}, {"&", Token_Ampersand}, {"0xffffffff", Token_Int_Hex}, {";", Token_Semicolon},
        {"*", Token_Star}, {"checksum", Token_Id}, {"=", Token_Assign}, {"readU32", Token_Id}, {"(", Token_Paren_Begin},
        {"buffer", Token_Id}, {"+", Token_Add}, {"8", Token_Int}, {")", Token_Paren_End}, {"&", Token_Ampersand},
        {"0xffffffff", Token_Int_Hex}, {";", Token_Semicolon}, {"*", Token_Star}, {"extra", Token_Id},
        {"=", Token_Assign}, {"readU32", Token_Id}, {"(", Token_Paren_Begin}, {"buffer", Token_Id}, {"+", Token_Add},
        {"12", Token_Int}, {")", Token_Paren_End}, {"&", Token_Ampersand}, {"0xffffffff", Token_Int_Hex},
        {";", Token_Semicolon}, {"}", Token_Scope_End}, {"int", Token_Int_Type}, {"unpack_file", Token_Id},
        {"(", Token_Paren_Begin}, {"const", Token_Const}, {"char", Token_Char_Type}, {"*", Token_Star},
        {"input_file", Token_Id}, {")", Token_Paren_End}, {"{", Token_Scope_Begin}, {"FILE", Token_Id},
        {"*", Token_Star}, {"in", Token_Id}, {";", Token_Semicolon}, {"unsigned", Token_Unsigned}, {"long", Token_Long},
        {"fsize", Token_Id}, {";", Token_Semicolon}, {"int", Token_Int_Type}, {"c", Token_Id}, {";", Token_Semicolon},
        {"unsigned", Token_Unsigned}, {"long", Token_Long}, {"percent", Token_Id}, {";", Token_Semicolon},
        {"unsigned", Token_Unsigned}, {"char", Token_Char_Type}, {"progress", Token_Id}, {"[", Token_Crochet_Begin},
        {"20", Token_Int}, {"]", Token_Crochet_End}, {";", Token_Semicolon}, {"int", Token_Int_Type},
        {"chunk_id", Token_Id}, {";", Token_Semicolon}, {"int", Token_Int_Type}, {"chunk_options", Token_Id},
        {";", Token_Semicolon}, {"unsigned", Token_Unsigned}, {"long", Token_Long}, {"chunk_size", Token_Id},
        {";", Token_Semicolon}, {"unsigned", Token_Unsigned}, {"long", Token_Long}, {"chunk_checksum", Token_Id},
        ...
        {"[", Token_Crochet_Begin}, {"BLOCK_SIZE", Token_Id}, {"]", Token_Crochet_End}, {";", Token_Semicolon},
        {"unsigned", Token_Unsigned}, {"long", Token_Long}, {"checksum", Token_Id}, {";", Token_Semicolon},
        {"unsigned", Token_Unsigned}, {"long", Token_Long}, {"decompressed_size", Token_Id}, {";", Token_Semicolon},
        {"unsigned", Token_Unsigned}, {"long", Token_Long}, {"total_extracted", Token_Id}, {";", Token_Semicolon},
        {"int", Token_Int_Type}, {"name_length", Token_Id}, {";", Token_Semicolon}, {"char", Token_Char_Type},
        {"*", Token_Star}, {"output_file", Token_Id}, {";", Token_Semicolon}, {"FILE", Token_Id}, {"*", Token_Star},
        {"f", Token_Id}, {";", Token_Semicolon}, {"unsigned", Token_Unsigned}, {"char", Token_Char_Type},
        {"*", Token_Star}, {"compressed_buffer", Token_Id}, {";", Token_Semicolon}, {"unsigned", Token_Unsigned},
        {"char", Token_Char_Type}, {"*", Token_Star}, {"decompressed_buffer", Token_Id}, {";", Token_Semicolon},
        {"unsigned", Token_Unsigned}, {"long", Token_Long}, {"compressed_bufsize", Token_Id}, {";", Token_Semicolon},
        {"unsigned", Token_Unsigned}, {"long", Token_Long}, {"decompressed_bufsize", Token_Id}, {";", Token_Semicolon},
        {"/* sanity check */", Token_Comment}, {"in", Token_Id}, {"=", Token_Assign}, {"fopen", Token_Id},
        {"(", Token_Paren_Begin}, {"input_file", Token_Id}, {",", Token_Comma}, {"\"rb\"", Token_String},
        {")", Token_Paren_End}, {";", Token_Semicolon}, {"if", Token_If}, {"(", Token_Paren_Begin}, {"!", Token_Not},
        {"in", Token_Id}, {")", Token_Paren_End}, {"{", Token_Scope_Begin}, {"printf", Token_Id},
        {"(", Token_Paren_Begin}, {"\"Error: could not open %s\\n\"", Token_String}, {",", Token_Comma},
        {"input_file", Token_Id}, {")", Token_Paren_End}, {";", Token_Semicolon}, {"return", Token_Return},
